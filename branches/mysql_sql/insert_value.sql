...
VALUES(1,'综合应用系统','Complex Application System.','LoginBoot','index.htm',0,0,'1.0.0.0',1,1,'2013-10-10 12:00:00.000000','2013-10-10 12:00:00.000000');
...
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1010,'MENU.001010',2,1000,'system/role.do','system-role',1,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1011,'MENU.001011',1,1010,'','system-role-add',2,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1012,'MENU.001012',1,1010,'','system-role-upd',2,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1013,'MENU.001013',1,1010,'','system-role-del',2,2);
-- System User Management
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1020,'MENU.001020',2,1000,'system/user.do','system-user',1,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1021,'MENU.001021',1,1020,'','system-user-add',2,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1022,'MENU.001022',1,1020,'','system-user-upd',2,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1023,'MENU.001023',1,1020,'','system-user-del',2,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1024,'MENU.001024',1,1020,'','system-user-rpw',2,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1025,'MENU.001025',1,1025,'','system-user-userAccExp',0,2);
-- 权限管理
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1030,'MENU.001030',2,1000,'system/menu.do','system-menu',1,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1032,'MENU.001032',1,1030,'','system-menu-upd',2,2);
-- 系统参数
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1040,'MENU.001040',2,1000,'system/param.do','system-param',1,2);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1042,'MENU.001042',1,1040,'','system-param-upd',2,2);
-- System Client Management
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
VALUES(1050,'MENU.001050',2,1000,'system/appList.do','system-client',1,0);
INSERT INTO T_MENU(MID,NAME,TYPE,PID,URI,PERMISSION,DEPTH,`RANGE`)
